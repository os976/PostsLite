...
public abstract interface PostDao {
    ...
    @androidx.room.Query(value = "DELETE FROM saved_posts WHERE id = :id")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object deleteById(int id, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion);
    
    @androidx.room.Query(value = "DELETE FROM saved_posts WHERE id IN (:ids)")
    @org.jetbrains.annotations.Nullable()
    ...
    @androidx.room.Query(value = "DELETE FROM saved_posts")
    @org.jetbrains.annotations.Nullable()
